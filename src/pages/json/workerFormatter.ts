...
// function decorateWithSpan(value: any, className: any) {
//   return '<span class="' + className + '">' + htmlEncode(value) + '</span>'
// }

// function valueToHTML(value: any) {
...
//     } else {
//       if (isJsonStr(value)) {
//         output += objectToHTML(JSON.parse(value))
//       } else {
...
// function objectToHTML(json: any) {
...
// export function jsonToHTML(json: any, fnName?: any) {
//   let output = ''
//   if (fnName) {
...
// function isJsonStr(jsonStr: string) {
//   try {
...
export const name = 'workerFormatter'
